...
%
%%%This version is different from the  analysis_snap_deriv_tauleap in that
%%%when [1,3] or [2,3] are giving trivial derivative (D is too far), then it
%%%ignores the 5th derivative.
%
%Input
%
...
function [derivative, energy] = analysis_snap_deriv_tauleap2(init, theta, tend, ...
